...
from hifigan.logger import setup_logging
from hifigan.utils import read_json, write_json, ROOT_PATH
    ...
    def from_args(cls, args, options=""):
        ...
        if args.resume is not None:
            ...
            if args.config is not None:
                ...
                path_to_config = ROOT_PATH / "pix2pix" / "configs" / \
                                 "facades_config.json"
            resume = None
            cfg_fname = Path(path_to_config)
